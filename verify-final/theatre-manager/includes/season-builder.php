...
function tm_render_season_builder_page() {
    ...
    if (empty($show_rows)) {
        $show_rows = array(
            'show_new_1' => array('id' => '', 'name' => '', 'author' => '', 'sub_authors' => '', 'synopsis' => '', 'audition_date' => '', 'audition_details' => '', 'genre' => '', 'director' => '', 'associate_director' => '', 'time_slot' => '', 'show_dates' => '', 'sm_image' => '', 'program_id' => '', 'program_url' => ''),
        );
    }
    $casts_by_show = array();
