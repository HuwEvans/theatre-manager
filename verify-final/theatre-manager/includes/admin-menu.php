...
function tm_display_options_page() {
	$tabs = ['board_member', 'advertiser', 'sponsor', 'contributor', 'testimonials', 'season', 'show', 'cast', 'auditions'];
...
function tm_instructions_page() {
	...
	echo "<h3>14. [tm_board_members]</h3>";
	...
	echo "<ul>";
	echo "<li><strong>Board Members, Advertisers, Sponsors, Contributors, Testimonials, Seasons, Shows, Cast, Auditions</strong> - Each has independent display settings</li>";
