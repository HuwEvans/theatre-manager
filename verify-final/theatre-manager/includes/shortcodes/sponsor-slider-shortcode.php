...
function tm_sponsor_slider_shortcode($atts) {
    ...
    $base_font = get_option('tm_sponsor_base_font', 'Arial, sans-serif');

    $style = "background-color: {$bg_color}; font-family: {$base_font}; border: {$border_width}px solid {$border_color};";
    if ($rounded === 'true') {
