...
function tm_season_builder_handle_save() {
    ...
    foreach ($shows_in as $row_key => $row) {
        ...
        $show_dates = sanitize_textarea_field($row['show_dates'] ?? '');
...
function tm_render_season_builder_page() {
    ...
    if (empty($show_rows)) {
        $show_rows = array(
            'show_new_1' => array('id' => '', 'name' => '', 'author' => '', 'sub_authors' => '', 'synopsis' => '', 'audition_date' => '', 'audition_details' => '', 'genre' => '', 'director' => '', 'associate_director' => '', 'time_slot' => '', 'show_dates' => '', 'venue' => '', 'sm_image' => '', 'program_id' => '', 'program_url' => ''),
        );
    }
    $casts_by_show = array();
                    ...
                    <div class="tm-sb-show-card postbox" data-show-ref="<?php echo esc_attr($row_key); ?>" style="margin-bottom: 20px;">
                        ...
                        <div class="inside">
                            <table class="form-table" role="presentation">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><textarea class="large-text" rows="3" name="shows[<?php echo esc_attr($row_key); ?>][show_dates]"><?php echo esc_textarea($row['show_dates']); ?></textarea></td>
                                    </tr>
                                    <tr>
                            ...
                            <table class="widefat striped tm-sb-cast-table">
                                <thead>
                                    <tr>
                                        <th style="width: 42%;">Character Name</th>
                                        <th style="width: 42%;">Actor Name</th>
    ...
    (function($){
        ...
        function addShowRow() {
            ...
            var html = '' +
                ...
                '          </td>' +
                '        </tr>' +
                '        <tr><th scope="row">Show Dates</th><td><textarea class="large-text" rows="3" name="shows[' + escHtml(rowKey) + '][show_dates]"></textarea></td></tr>' +
                ...
                '    <h3>Cast</h3>' +
                '    <table class="widefat striped tm-sb-cast-table">' +
                '      <thead><tr><th style="width: 42%;">Character Name</th><th style="width: 42%;">Actor Name</th><th style="width: 16%;">Remove</th></tr></thead>' +
                '      <tbody></tbody>' +
                '    </table>' +
