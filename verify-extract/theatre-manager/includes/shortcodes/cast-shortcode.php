...
function tm_shortcode_cast($atts) {
    ...
    $border_color = get_option('tm_cast_border_color', '#cccccc');
    ...
    $base_font = get_option('tm_cast_base_font', 'Arial, sans-serif');
    $style = sprintf('background-color:%s;color:%s;font-family:%s;border:%spx solid %s;border-radius:%spx;box-shadow:%s;', esc_attr($bg_color), esc_attr($text_color), esc_attr($base_font), esc_attr($border_width), esc_attr($border_color), esc_attr($rounded), esc_attr($shadow));
