...
function tm_board_member_shortcode($atts) {
    ...
    $base_font = get_option('tm_board_member_base_font', 'Arial, sans-serif');
    $atts = shortcode_atts([
        'show_photos' => 'true',
        'columns' => $grid_columns,
    ], $atts, 'tm_board_members');
	
    $style = "background-color: {$bg_color}; color: {$text_color}; font-family: {$base_font}; border: {$border_width}px solid {$border_color}; box-sizing: border-box; padding:15px;";
