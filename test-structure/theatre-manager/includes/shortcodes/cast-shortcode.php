...
function tm_shortcode_cast($atts) {
    ...
    $style = sprintf('background-color:%s;color:%s;font-family:%s;border-width:%spx;border-style:solid;border-radius:%spx;box-shadow:%s;', esc_attr($bg_color), esc_attr($text_color), esc_attr($base_font), esc_attr($border_width), esc_attr($rounded), esc_attr($shadow));
